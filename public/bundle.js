...
function form() {
  ...
  function submissionForm(element) {
    element.addEventListener('submit', function (a) {
      ...
      var formData = new FormData(element); // let obj = {};
...
function modal() {
  ...
  function modalOpen() {
    overlay.style.display = 'block', this.classList.add('more-splash'), document.body.style.overflow = 'hidden';
  }

  function modalClose() {
    overlay.style.display = 'none', more.classList.remove('more-splash'), document.body.style.overflow = '';
  }
